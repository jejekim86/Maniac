...
public class Player : Controller
{
    ...
    [SerializeField] private float itemMoveSpeed = 1.0f; // 占쏙옙占쏙옙占쏙옙 占싱듸옙 占쌈듸옙
    [SerializeField] private float itemRange = 5f; // 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙占 占쏙옙占쏙옙
    ...
    {
        // "Item" 占승그몌옙 占쏙옙占쏙옙 占쏙옙占 占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙트占쏙옙 찾占쏙옙
        GameObject[] items = GameObject.FindGameObjectsWithTag("Item");

        foreach (GameObject item in items)
        {
            // 占시뤄옙占싱억옙占 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙占 占신몌옙 占쏙옙占
            Vector3 relativePos = item.transform.position - transform.position;

            // 占시뤄옙占싱억옙占쏙옙占 占신몌옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占쏙옙占쏙옙 占싱듸옙
            if (relativePos.magnitude <= itemRange)
            {
                // 占쏙옙占쏙옙占쏙옙占쏙옙 占시뤄옙占싱어에占쏙옙 占싸드럽占쏙옙 占싱듸옙
